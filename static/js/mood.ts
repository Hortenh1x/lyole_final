document.addEventListener('DOMContentLoaded', () => {
    const button = document.getElementById('complimentBtn') as HTMLButtonElement | null;
    const card = document.getElementById('card') as HTMLDivElement | null;
    const complimentText = document.getElementById('complimentText') as HTMLParagraphElement | null;
